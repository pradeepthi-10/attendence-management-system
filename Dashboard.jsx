...
import Sidebar from './frontend/frontend-react/src/components/Sidebar';
import DashboardCard from './frontend/frontend-react/src/components/DashboardCard';
import StudentStatus from './frontend/frontend-react/src/components/StudentStatus';
import Navbar from './frontend/frontend-react/src/components/Navbar';
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <p>Welcome to the Attendance Management System dashboard</p>
            <div className="row">
              <div className="col-md-3">
